...
const Calendar = () => {
  ...
  console.log(currentWeekStart.getDay(), '- getDay() from currentWeekStart');

  const weekEnd = new Date(currentWeekStart);
  weekEnd.setDate(currentWeekStart.getDay() + 6);

  console.log(weekEnd.getDay(), '- week end');
  ...
  const datesRange = `${currentWeekStart.getDate()} / ${weekStartMonthNumber} — ${weekEnd.getDate()} / ${weekEndMonthNumber}`;
