      ...
      {weekDays.map((day, index) => {
        ...
        {intervalSlots.map((interval, index) => {
            ...
            return (
                ...
                // <div className="hour-interval-empty" data-interval={JSON.stringify(interval)} onClick={handleIntervalClick} key={index}> </div>
                <div className="hour-interval-empty" key={index} >TEST</div>
            ) 
        })}
        </div>
        )
