  ...
  return (
    <div className="calendar-days-wrapper">
      {weekDays.map((day, index) => {
        ...
        {hours.map((hour) => {
            return (
                <div className={isOccupied ? "hour-intervals-empty" : "hour-intervals-occupied"} data-interval={JSON.stringify({ hour, day , currentDates: currentDates[index-1], isOccupied})} key={hour} onClick={handleIntervalClick}> </div>
            )
        })}
        </div>
        )
